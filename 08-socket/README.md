...
bpftool prog load 08-socket/sockops_tracker.o $BPFFS/sockops_tracker pinmaps $BPFFS/sockops_maps
...
bpftool prog load 08-socket/sk_msg_redirect.o $BPFFS/sk_msg_redirect \
